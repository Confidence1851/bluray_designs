    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="{{url('/')}}"><img src="{{asset('dashboard/images/icon/logo.png') }}" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                 <a href="{{ route('products') }}"><i class="ti-item"></i><span>Products</span></a>
                            </li>

                            <li>
                                 <a href="{{ route('orders') }}"><i class="ti-request"></i><span>Orders</span></a>
                            </li>

                            <li>
                                 <a href="{{ route('allposts') }}"><i class="ti-book"></i><span>Posts</span></a>
                            </li>

                            <li>
                                 <a href=""><i class="ti-comment"></i><span>Comments</span></a>
                            </li>
