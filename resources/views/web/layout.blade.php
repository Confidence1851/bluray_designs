...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
        href="{{ $web_source }}/ico/apple-touch-icon-144-precomposed.png" />
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
        href="{{ $web_source }}/ico/apple-touch-icon-114-precomposed.png" />
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
        href="{{ $web_source }}/ico/apple-touch-icon-72-precomposed.png" />
            ...
            <div class="hidden-top">
                <div class="hidden-top-inner container">
                    <div class="row">
                        <div class="span12">
                            <ul>
                                <li><strong>We are always available to meet your design and print needs, get in
                                        touch</strong></li><br>
                                <li><b>Office Address:</b> Shop 1, Elemoro Shopping Complex, Bola Ahmed Tinubu Road,
                                    Bogije, Ibeju-Lekki, Lagos, Nigeria</li>
            ...
            <header>
                <div class="container ">
                    ...
                    <div class="row nomargin">
                        <div class="span12">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input id="name" type="text" id="signup-name"
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input id="phone" type="text" id="signup-phone"
                            ...
                            <div id="mySignin" class="modal styled hide fade" tabindex="-1" role="dialog"
                                aria-labelledby="mySigninModalLabel" aria-hidden="true" backdrop="static">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">×</button>
                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="logo">
                                <a href="{{ url('/') }}"><img src="{{ $web_source }}/img/logo.png" alt="" width="300"
                                        class="Bluraydesigns logo" /></a>
                                        ...
                                        <ul class="nav topnav">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    @php($products = App\Product::where('status', 'Active')
                                                        ->orderby('name', 'asc')
                                                        ->get(),)
                                                        @foreach ($products as $product)
                                                            <li><a
                                                                    href="{{ route('productdetail', $product->id) }}">{{ strtoupper($product->name) }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="dropdown" style="display:none">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        @foreach ($cats as $category)
                                                            <li><a
                                                                    href="{{ route('portfolio', $category) }}">{{ $category }}</a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                </li>
                        ...
                        <div class="span3">
                            <div class="widget">
                                ...
                                <div class="flickr_badge">
                                    ...
                                    <div class="fb-page" data-href="https://www.facebook.com/bluraydesigntech/"
                                        data-tabs="timeline, messages" data-width="" data-height=""
                                        data-small-header="false" data-adapt-container-width="true" data-height="150"
                                        data-width="300" data-hide-cover="false" data-show-facepile="true">
                                        <blockquote cite="https://www.facebook.com/bluraydesigntech/"
                                            class="fb-xfbml-parse-ignore"><a
                                                href="https://www.facebook.com/bluraydesigntech/">Bluray DesignTech</a>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
