        ...
        <div class="section-body">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="#">
                    <div class="row mb-5">
                            <div class="col-md-6"><label for="">Product Name</label><input type="text" id="prodname" required autofocus class="form-control"></div>
                            ...
                            <div class="col-md-4 mt-4"><label for="">Design Price</label><input type="number" id="design_price" required autofocus value="" class="form-control"></div>
                            <div class="col-md-4 mt-4"><label for="">Caption</label><input type="text" id="caption" required autofocus value="" class="form-control"></div>
                            <div class="col-md-4 mt-4"><button type="submit" class="btn btn-block btn-primary mt-2" id="addprod">Add</button></div>
                        </div>
                    </form>
                  </div>
                </div>
