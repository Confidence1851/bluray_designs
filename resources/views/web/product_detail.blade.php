      ...
      <div id="nivo-slider">
        <div class="nivo-slider">
         @foreach($images as $img)
            <img src="{{ asset('public/product_images/'.$img->image) }}" alt="Product image" title="Product image" />
          @endforeach
        </div>
      </div>
      <!-- end slider -->
...
<div class="control-group">
  ...
  <label> {{$product->name}} Type<br>
   ...
   @foreach($quantities as $quan)
      <option value="{{$quan->id}}|{{$quan->quantity}}|{{$quan->discount}}">{{$quan->quantity}}</option>
     @endforeach
   </select>
   <br>
  ...
  <div class="control-group">
      ...
      I don't have a design yet, create one for me. Price: NGN {{$product->design_price}}</label>
  </div>
