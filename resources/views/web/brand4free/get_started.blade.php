        ...
        <div class="row" style="margin-top:3%; margin-bottom:10%; color:#333;">
            ...
            <div class="col-md-5 col-sm-10 jumbotron  col-lg-5"
                ...
                <ul>
                    ...
                    <li>Businesses that centers on multi-level marketing, betting/gambling, cryptocurrencies, sex related
                        products/services and any other business deemed as illegal/morally inappropriate are not considered.
                    </li><br>
            ...
            <div class="col-md-6 col-sm-12 col-lg-6 push-right"
                ...
                <form method="post" action="{{ route('brand_4_free.get_started') }}" class="was-validated"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" id="offer" name="summary" minlength="150" maxlength="400"
                            required></textarea>
                    </div>
