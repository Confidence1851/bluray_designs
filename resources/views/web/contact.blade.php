...
@section('content')
    ...
    <div class="container" style="margin-top:5%;">
      <div class="row">
        ...
        <div class="span8">
          <div>
              <iframe src="https://www.google.com/maps/embed?pb=!1m22!1m8!1m3!1d3964.352875037219!2d3.7560132147704666!3d6.476911645314549!3m2!1i1024!2i768!4f13.1!4m11!3e6!4m3!3m2!1d6.4766905999999995!2d3.7583238999999997!4m5!1s0x10395545f992b099%3A0x98377979c6f14fea!2sbluraydesigns%20tech!3m2!1d6.477161199999999!2d3.7582818!5e0!3m2!1sen!2sng!4v1599590004668!5m2!1sen!2sng" width="800" height="420" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
          </div>
            ...
            <form action="{{ route('contactMsg') }}" method="post" role="form" class="">@csrf
              ...
              <div class="row">
                ...
                <div class="span12 margintop10 form-group">
                  <textarea class="form-control" name="message" rows="12" data-rule="required" required data-msg="Please write something for us" placeholder="Message"></textarea>
                  <div class="validation"></div>
                  <p class="text-center">
