        ...
        <div class="container" style="margin-bottom:0px;">
          <div class="span12">
            ...
            <ul id="mycarousel" class="jcarousel-skin-tango recent-jcarousel clients">
              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/northbridge.png" class="client-logo" alt="Northbridge" />
					</a>
              </li>

              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/bready.png" class="client-logo" alt="Bready Bakery" />
					</a>
              </li>
              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/chrisabella.png" class="client-logo" alt="Chrisabella" />
					</a>
              </li>
              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/onkleonz.png" class="client-logo" alt="Onkleonz" />
					</a>
              </li>
              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/rarefruits.png" class="client-logo" alt="Rarefruits" />
					</a>
              </li>
              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/savanahgrill.png" class="client-logo" alt="Savannah Grill" />
					</a>
              </li>
              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/boldlink.png" class="client-logo" alt="Boldlink" />
					</a>
              </li>
              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/raldbelle.png" class="client-logo" alt="Radbelle" />
					</a>
              </li>

              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/landvantage.png" class="client-logo" alt="Landvantage" />
					</a>
              </li>
              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/inasa.png" class="client-logo" alt="Inasa Fashion" />
					</a>
              </li>
              <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/golden.png" class="client-logo" alt="Golden" />
					</a>
              </li>
               ...
               <li>
                <a href="#">
					<img src="/public/web/img/dummies/clients/delantech.png" class="client-logo" alt="Delantech" />
					</a>
              </li>
